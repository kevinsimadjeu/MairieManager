...
if (isset($_POST) && !empty($_POST)) {
    ...
    $nm = $_POST['nommere'];
    $dm = $_POST['date_dem'];
    $st = $pdo->prepare('INSERT INTO demande_acte_mariage(nom_enfant,date_naissance,lieu_naissance,nom_pere,nom_mere,date_demande) VALUES(:nom_enfant,:datenais,:lieunais,:nom_pere,:nom_mere,:date_demande');
